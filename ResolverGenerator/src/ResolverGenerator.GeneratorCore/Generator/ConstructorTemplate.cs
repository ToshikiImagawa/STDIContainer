...
namespace ResolverCompiler.Generator {
    ...
    public partial class ConstructorTemplate : ConstructorTemplateBase {
...
namespace ");
    ...
    for (var i = 0; i < ConstructorInfos.Length; i++)
    {
        ...
        foreach (var parameterTypeInfo in constructorInfo.ParameterTypeInfos)
        {
            ...
            this.Write("                // ");
            this.Write(this.ToStringHelper.ToStringWithCulture( parameterTypeInfo.FullName ));
            this.Write("\n                typeof(");
            this.Write(this.ToStringHelper.ToStringWithCulture( parameterTypeInfo.FullName ));
            this.Write("),\n");
            ...
            this.Write("            };\n        }\n\n        public global::System.Type[] GetParameterTypes(" +
                    ") => _parameterTypes;\n\n        public ");
            this.Write(this.ToStringHelper.ToStringWithCulture( constructorInfo.FullName ));
            this.Write(" New(object[] parameters)\n        {\n");
...
#pragma warning restore SA1129");
    ...
    public class ConstructorTemplateBase {
